...
import { TrendingUp, TrendingDown, FileDown, Activity, MessageCircle } from "lucide-react";
...
export function Summary({ transactions, exchangeRates, lastMonthTransactions }: SummaryProps) {
  ...
  const savePhoneNumber = async () => {
    ...
    const result = await linkWhatsAppNumber(formattedPhone, session.access_token);
