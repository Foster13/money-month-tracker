      ...
      <Card className="glass-card animate-scale-in overflow-hidden">
        ...
        <CardContent className="px-4 sm:px-6 pb-6 space-y-4">
          <p className="text-sm sm:text-base text-muted-foreground">
            Use simulation mode to project future finances without affecting your actual data. Your
            current transactions will be loaded as a starting point.
          </p>
          <Button
