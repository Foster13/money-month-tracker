...
export function Icon({
  ...
  const sizeValue = typeof size === "number" ? size : parseInt(iconSizes[size]);
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    home: (
      ...
      >
        ...
        <path
          d="M14 30L32 14L50 30V52C50 53.1046 49.1046 54 48 54H16C14.8954 54 14 53.1046 14 52V30Z"
          fill="url(#homeGrad1)"
        />
    ...
    income: (
      ...
      >
        <ellipse cx="32" cy="58" rx="18" ry="3" fill="#000000" opacity="0.1" />
        <path
          d="M32 12C32 12 24 14 24 18V20C24 20 20 22 20 28V46C20 50 24 54 32 54C40 54 44 50 44 46V28C44 22 40 20 40 20V18C40 14 32 12 32 12Z"
          fill="url(#incomeGrad1)"
        />
        <ellipse cx="32" cy="20" rx="8" ry="3" fill="#2E7D32" />
        <path
          d="M32 26V48M32 26C29 26 27 28 27 30C27 32 29 33 32 33C35 33 37 34 37 36C37 38 35 40 32 40M32 26C35 26 37 28 37 30M32 48C29 48 27 46 27 44M32 48C35 48 37 46 37 44"
          stroke="#FFD700"
          strokeWidth="2.5"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    expenses: (
      ...
      >
        <ellipse cx="32" cy="58" rx="18" ry="3" fill="#000000" opacity="0.1" />
        <path
          d="M12 20C12 17.7909 13.7909 16 16 16H48C50.2091 16 52 17.7909 52 20V48C52 50.2091 50.2091 52 48 52H16C13.7909 52 12 50.2091 12 48V20Z"
          fill="url(#expensesGrad1)"
        />
        <path
          d="M12 20C12 17.7909 13.7909 16 16 16H48C50.2091 16 52 17.7909 52 20V26H12V20Z"
          fill="url(#expensesGrad2)"
        />
        <rect x="16" y="30" width="20" height="3" rx="1.5" fill="#FF1493" opacity="0.6" />
        <path
          d="M38 32H48C49.1046 32 50 32.8954 50 34V42C50 43.1046 49.1046 44 48 44H38V32Z"
          fill="url(#expensesGrad3)"
        />
    ...
    budget: (
      ...
      >
        ...
        <text x="32" y="22" fontSize="4" fill="#FFD700" textAnchor="middle" fontWeight="bold">
          $
        </text>
        <path
          d="M14 36C14 36 12 34 12 32C12 30 14 28 14 28"
          stroke="url(#budgetGrad2)"
          strokeWidth="2.5"
          strokeLinecap="round"
          fill="none"
        />
    ...
    rates: (
      ...
      >
        ...
        <path
          d="M24 24V40M24 24C21 24 19 26 19 28C19 30 21 31 24 31C27 31 29 32 29 34C29 36 27 38 24 38M24 24C27 24 29 26 29 28M24 40C21 40 19 38 19 36M24 40C27 40 29 38 29 36"
          stroke="#FFA500"
          strokeWidth="2"
          strokeLinecap="round"
        />
        ...
        <path
          d="M45 26C45 26 43 24 40 24C36 24 33 27 33 32C33 37 36 40 40 40C43 40 45 38 45 38M33 30H43M33 34H43"
          stroke="#1976D2"
          strokeWidth="2"
          strokeLinecap="round"
        />
        <path
          d="M28 22L36 22L34 20M36 42L28 42L30 44"
          stroke="#4CAF50"
          strokeWidth="2.5"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    heart: (
      ...
      >
        ...
        <path
          d="M32 54C32 54 12 42 12 26C12 14 20 10 26 14C28 15 30 17 32 20C34 17 36 15 38 14C44 10 52 14 52 26C52 42 32 54 32 54Z"
          fill="url(#heartGrad1)"
        />
        <path
          d="M32 20C34 17 36 15 38 14C44 10 52 14 52 26C52 30 50 34 46 38"
          fill="url(#heartGrad2)"
          opacity="0.6"
        />
    ...
    sparkles: (
      ...
      >
        ...
        <path
          d="M32 8L34 18L44 20L34 22L32 32L30 22L20 20L30 18L32 8Z"
          stroke="#FFA500"
          strokeWidth="1.5"
          strokeLinejoin="round"
        />
        ...
        <path
          d="M48 14L49 18L53 19L49 20L48 24L47 20L43 19L47 18L48 14Z"
        ...
        />
        <path
          d="M16 40L17 44L21 45L17 46L16 50L15 46L11 45L15 44L16 40Z"
          fill="url(#sparkleGrad3)"
        />
        <path
          d="M16 40L17 44L21 45L17 46L16 50L15 46L11 45L15 44L16 40Z"
          stroke="#4ECDC4"
        ...
        />
        <path
          d="M52 36L52.5 38L54.5 38.5L52.5 39L52 41L51.5 39L49.5 38.5L51.5 38L52 36Z"
          fill="#FFD93D"
        />
        <path
          d="M12 24L12.5 26L14.5 26.5L12.5 27L12 29L11.5 27L9.5 26.5L11.5 26L12 24Z"
          fill="#95E1D3"
        />
        <path
          d="M44 48L44.5 50L46.5 50.5L44.5 51L44 53L43.5 51L41.5 50.5L43.5 50L44 48Z"
          fill="#F38181"
        />
