...
export function BudgetSection({ transactions, categories, exchangeRates }: BudgetSectionProps) {
  ...
  const categoryStats = currentMonthTransactions.reduce(
    (acc, t) => {
        ...
        <CardHeader className="px-4 sm:px-6 py-4 sm:py-5">
          <div className="flex items-center gap-3">
            <div className="min-w-0">
              <CardTitle className="text-lg sm:text-xl lg:text-2xl text-budget truncate">
                Monthly Budget
              </CardTitle>
        ...
        <CardContent className="px-4 sm:px-6 pb-6 space-y-4 sm:space-y-5">
            ...
            {isEditing ? (
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="bg-budget hover:opacity-90 flex-shrink-0 min-h-[44px] min-w-[44px]"
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <div className="text-right min-w-0 flex-1">
                  ...
                  <p
                    className={`font-semibold text-sm sm:text-base break-words ${budgetRemaining >= 0 ? "text-budget" : "text-expense"}`}
                  >
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-4 border-t">
            <div className="text-center">
              <TrendingUp
                className="h-5 w-5 sm:h-6 sm:w-6 text-income mx-auto mb-1"
                aria-hidden={true}
              />
            ...
            <div className="text-center">
              <TrendingDown
                className="h-5 w-5 sm:h-6 sm:w-6 text-rose-500 mx-auto mb-1"
                aria-hidden={true}
              />
            ...
            <div className="text-center">
              <Wallet
                className="h-5 w-5 sm:h-6 sm:w-6 text-budget mx-auto mb-1"
                aria-hidden={true}
              />
              <p className="text-xs sm:text-sm text-muted-foreground">Balance</p>
              <p
                className={`font-semibold text-sm sm:text-base break-words ${balance >= 0 ? "text-budget" : "text-expense"}`}
              >
