...
import { TrendingUp, ArrowUpDown, Calendar, Tag, DollarSign, Plus } from "lucide-react";
...
type SortOption =
  "date-desc" | "date-asc" | "amount-desc" | "amount-asc" | "category" | "alphabetical";
...
export function IncomeSection({
  ...
  const sortedIncome = [...income].sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case "amount-desc":
        result =
          convertToIDR(b.amount, b.currency, exchangeRates) -
          convertToIDR(a.amount, a.currency, exchangeRates);
        break;
      case "amount-asc":
        result =
          convertToIDR(a.amount, a.currency, exchangeRates) -
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="min-w-0">
                <CardTitle className="text-lg sm:text-xl lg:text-2xl text-income truncate">
                  Income
                </CardTitle>
        ...
        <CardContent className="px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between">
            ...
            <Button
              onClick={() => onAdd?.()}
              size="sm"
              className="bg-income hover:bg-income/90 text-income-foreground min-h-[44px] w-full sm:w-auto ml-auto"
