...
export default function IconsPreviewPage() {
  const icons = [
    { name: "home", label: "Home", color: "text-primary" },
    ...
    { name: "heart", label: "Heart", color: "text-primary" },
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-display bg-gradient-to-r primary bg-clip-text text-transparent">
          Icons Preview - Lineal Color Style
        </h1>
        <p className="text-body">Flaticon-inspired icons with colorful accents</p>
      </div>
          ...
          <div className="space-y-6">
            {sizes.map((size) => (
              <div key={size.value} className="space-y-2">
                <h3 className="text-caption font-semibold text-muted-foreground">{size.label}</h3>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-2xl font-bold text-green-600">Rp 10,000,000</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center gap-2">
                ...
                <CardContent>
                  <p className="text-2xl font-bold text-expense">Rp 7,500,000</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center gap-2">
                ...
                <CardContent>
                  <p className="text-2xl font-bold text-purple-600">Rp 2,500,000</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              <p className="flex items-center gap-2 text-lg">
                ...
                <span className="font-bold bg-gradient-to-r primary bg-clip-text text-transparent">
